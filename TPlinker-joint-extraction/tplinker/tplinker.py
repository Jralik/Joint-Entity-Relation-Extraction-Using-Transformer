...
class TPLinkerBert(nn.Module):
    def __init__(self, encoder, 
        ...
        # handshaking kernel (tropical_num_pieces chỉ có tác dụng với tropical_cln / tropical_cln_plus)
        self.handshaking_kernel = HandshakingKernel(hidden_size, shaking_type, inner_enc_type, tropical_num_pieces)
