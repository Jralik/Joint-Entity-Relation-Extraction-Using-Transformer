...
#     "encoder": "BiLSTM",
    "encoder": "BERT", 
    "hyper_parameters": {
        "shaking_type": "tropical_cln", # cat, cat_plus, cln, cln_plus, tropical_cln, tropical_cln_plus
        "tropical_num_pieces": 4, # số phân vùng K cho TropicalLayerNorm
...
train_config = {
    ...
    "rel2id": "rel2id.json",
    "logger": "default", # if wandb, comment the following four lines
    ...
    "hyper_parameters": {
        "batch_size": 24,
        "epochs": 100,
        "early_stopping_patience": 7, # Dừng sớm nếu không cải thiện sau 10 epochs
        "seed": 2333,
        "log_interval": 10,
        "max_seq_len": 100,
        "sliding_len": 20,
...
bert_config = {
    ...
    "bert_path": "bert-base-cased", # Tải trực tiếp từ huggingface
    "hyper_parameters": {
        "lr": 5e-5,
    },
}
